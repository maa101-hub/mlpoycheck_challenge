...
// Authenticated user changes their own password (must come before '/:id').
router.post('/change-password', authenticate, simulateDelay(800), UserController.changePassword);
